...
def process(filename1,filename2):
    ...
    base_image_path = 'C:/Users/this pc/Desktop/TechnoArt/src/flask_pack/static/nstimages/'+filename1
    style_reference_image_path = 'C:/Users/this pc/Desktop/TechnoArt/src/flask_pack/static/nstimages/'+filename2
    ...
    content = Image.open(base_image_path).convert("RGB")
    content = transform(content).to(device)
    print("COntent shape => ", content.shape)
    style = Image.open(style_reference_image_path).convert("RGB")
    ...
    for i in range(1,epochs+1):
        ...
        if i==epochs:   
            plt.imsave('C:/Users/this pc/Desktop/TechnoArt/src/flask_pack/static/nstimages/results0.png', np.clip(imcnvt(target), 0, 1), format='png')